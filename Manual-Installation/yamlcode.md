...
- The following steps are a repeat of the previous section, I will just put the images here as a reminder. If you need the full guide, go back to the [Loading ESPHome on the Device](https://docs.asc.com/Manual-Installation/mat_install.html) on the side navigation bar.
...
If this step fails go to [Boot Mode Instructions](https://docs.asc.com/bootmode.html).
...
## Next Steps
Let's move on to [configuring the device into the Home Assistant UI](https://docs.asc.com/Manual-Installation/HAintegration.html).
